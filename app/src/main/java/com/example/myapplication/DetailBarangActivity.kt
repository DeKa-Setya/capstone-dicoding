...
import com.example.myapplication.databinding.ActivityDetailBarangBinding
...
class DetailBarangActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_detail_barang)
